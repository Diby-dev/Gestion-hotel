...
export default function PourquoiNous() {
  return (
    <section id="services" className="relative py-16 px-4 md:px-8 overflow-hidden scroll-mt-12">
      ...
      <div className="relative z-10 max-w-7xl mx-auto space-y-12">
        ...
        <div className="text-center space-y-3">
          <Reveal as="h2" animation="fade-down" duration={600} className="text-3xl md:text-4xl font-extrabold text-gray-50 tracking-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* CARTE 1 : Paiement d'acompte flexible - vient de la gauche */}
          <Reveal animation="fade-right" delay={100} duration={700}>
            <div className="h-full bg-white/95 backdrop-blur-xs p-8 rounded-3xl shadow-sm border border-gray-100 flex flex-col justify-between hover:shadow-md transition-shadow">
          ...
          {/* CARTE 2 : Équipements garantis 24h/24 - vient du bas */}
          ...
          {/* CARTE 3 : Centralisation des hôtels - vient de la droite */}
